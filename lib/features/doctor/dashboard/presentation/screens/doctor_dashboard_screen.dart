...
import 'package:serfix/core/widgets/skeleton_loader.dart';
...
class _DoctorDashboardScreenState extends State<DoctorDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ScreeningCubit, ScreeningState>(
      builder: (context, state) {
        if (state is ScreeningLoading || state is ScreeningInitial) {
  ...
  Widget _buildStatsSection(BuildContext context, ScreeningState state) {
  ...
  Widget _buildRecentActivitySection(BuildContext context, ScreeningState state) {
    final colorScheme = Theme.of(context).colorScheme;
      ...
      return Center(
        child: Column(
          children: [
            ...
            const SizedBox(height: 12),
            ElevatedButton(
              onPressed: () => context.read<ScreeningCubit>().loadScreenings(),
